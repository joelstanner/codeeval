...
and each player says next number in turn. However, any number divisible by
X (for example, three) is replaced by the word fizz, and any divisible by Y
...
function fizzbuzz(line) {
    var nums = line.split(" "),
        fb1 = parseInt(nums[0], 10),
        fb2 = parseInt(nums[1], 10),
        n = parseInt(nums[2], 10),
        output = ""
